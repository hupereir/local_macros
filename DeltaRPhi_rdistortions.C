...
//____________________________________________________________________________
TString DeltaRPhi_rdistortions( TString tag = TString() )
{
  ...
  const TString pdfFile = Form( "Figures/DeltaRPhi_rdistortions%s.pdf", tag.Data() );
  ...
  const TString var2d = Form( "%s:_clusters._trk_alpha", var.Data() );
