...
void CreateHotChannelMap(int runNumber = 41989)
{
  MicromegasMapping mapping;

  hot_channels.clear();

  const TString inputFile = Form( "DST/CONDOR_CombinedDataReconstruction_corrected/MicromegasCombinedDataEvaluation-%08i-0000-test.root", runNumber );
