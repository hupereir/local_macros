...
//_______________________________________________________________
void TpotMatchingDeltaZ_tile_fit_local()
{
  ...
  // print parameters
  std::cout << "TpotMatchingDeltaZ_tile_fit - runs: " << run_label << std::endl;
  std::cout << "TpotMatchingDeltaZ_tile_fit - vdrift_correction: " << f->GetParameter(0) << " +/- " << f->GetParError(0) << std::endl;
  for(int itile=0; itile<8; ++itile)
  {
    std::cout << "TpotMatchingDeltaZ_tile_fit - tile: " << itile << " offset: "  << f->GetParameter(itile+1) << " +/- " << f->GetParError(itile+1) << std::endl;
  }
}
