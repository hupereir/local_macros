...
TString DeltaZInvMomentum_truth( TString tag = TString() )
{
  ...
  const TString pdfFile = Form( "Figures_afs/DeltaZInvMomentum_truth%s_%i.pdf", tag.Data(), layer );
