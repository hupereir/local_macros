...
//   {
//     "Rootfiles/PullsZ_cluster_2k_realistic_full_nominal_old.root",
//     "Rootfiles/PullsZ_cluster_2k_realistic_full_nominal_new.root"
//   };
//
//   const TString pdfFile = "Figures/PullsZ_compare_new.pdf";

  const std::array<TString, nFiles> file =
  {
    "Rootfiles/PullsZ_truth_2k_realistic_full_nominal_old.root",
    "Rootfiles/PullsZ_truth_2k_realistic_full_nominal_new.root"
  };

  const TString pdfFile = "Figures/PullsZ_truth_compare_new.pdf";
  ...
  h->GetYaxis()->SetTitle( "pulls_{z} (cluster-truth)" );
