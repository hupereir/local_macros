...
void ConvertCalibrationToJSon( int runnumber = 45955 )
{

  const auto inputfile = Form("Calibrations/TPOT_Pedestal-%08i-0000.root", runnumber );
  const auto outputfile = Form("Calibrations/TPOT_Pedestal-%08i-0000.json", runnumber );
