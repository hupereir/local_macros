...
TString RawDataTiming( int runNumber = 9467 )
{
  ...
  const TString pdfFile = Form( "Figures/RawDataTiming-%08i-0000.pdf", runNumber );
  const TString rootfileName = Form( "Rootfiles/RawDataTiming-%08i-0000.root", runNumber );
