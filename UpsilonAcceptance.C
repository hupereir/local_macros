...
void UpsilonAcceptance()
{
  ...
  const TString pdfFile = Form( "Figures/UpsilonAcceptance%s.pdf", tag.Data() );
  ...
  {
    "all #Upsilon",
    "#Upsilon in acceptance (both electron E>2 GeV)",
    // "#Upsilon in acceptance (both electron E>1 GeV)",
